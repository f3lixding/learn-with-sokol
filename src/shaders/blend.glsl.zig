...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/blend.glsl -o src/shaders/blend.glsl.zig -l glsl410:glsl300es:hlsl5:metal_macos:wgsl -f sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'bg':
...
//
//
const vs_bg_source_glsl410 = [116]u8 {
...
//    void main()
//    {
//        vec2 _28 = fract((gl_FragCoord.xy - vec2(bg_fs_params[0].x)) * vec2(0.004999999888241291046142578125));
//        float _39 = _28.x * _28.y;
//        frag_color = vec4(_39, _39, _39, 1.0);
//    }
//
//
const fs_bg_source_glsl410 = [287]u8 {
    ...
    0x31,0x30,0x34,0x36,0x31,0x34,0x32,0x35,0x37,0x38,0x31,0x32,0x35,0x29,0x29,0x3b,
    ...
    0x20,0x76,0x65,0x63,0x34,0x28,0x5f,0x33,0x39,0x2c,0x20,0x5f,0x33,0x39,0x2c,0x20,
    0x5f,0x33,0x39,0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
//    #version 410
//
...
//
//
const vs_quad_source_glsl410 = [309]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x75,0x6e,
...
//
//
const fs_quad_source_glsl410 = [135]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x31,0x30,0x0a,0x0a,0x6c,0x61,
    0x79,0x6f,0x75,0x74,0x28,0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,
...
//    void main()
//    {
//        highp vec2 _28 = fract((gl_FragCoord.xy - vec2(bg_fs_params[0].x)) * vec2(0.004999999888241291046142578125));
//        highp float _39 = _28.x * _28.y;
//        frag_color = vec4(_39, _39, _39, 1.0);
//    }
//
//
const fs_bg_source_glsl300es = [360]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    ...
    0x6f,0x61,0x74,0x20,0x5f,0x33,0x39,0x20,0x3d,0x20,0x5f,0x32,0x38,0x2e,0x78,0x20,
    0x2a,0x20,0x5f,0x32,0x38,0x2e,0x79,0x3b,0x0a,0x20,0x20,0x20,0x20,0x66,0x72,0x61,
    0x67,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x5f,
    0x33,0x39,0x2c,0x20,0x5f,0x33,0x39,0x2c,0x20,0x5f,0x33,0x39,0x2c,0x20,0x31,0x2e,
...
//    }
//
const vs_bg_source_hlsl5 = [476]u8 {
...
//    void frag_main()
//    {
//        float2 _28 = frac((gl_FragCoord.xy - _17_tick.xx) * 0.004999999888241291046142578125f.xx);
//        float _39 = _28.x * _28.y;
...
//    }
//
const fs_bg_source_hlsl5 = [736]u8 {
    ...
    0x5f,0x74,0x69,0x63,0x6b,0x2e,0x78,0x78,0x29,0x20,0x2a,0x20,0x30,0x2e,0x30,0x30,
    0x34,0x39,0x39,0x39,0x39,0x39,0x39,0x38,0x38,0x38,0x32,0x34,0x31,0x32,0x39,0x31,
    0x30,0x34,0x36,0x31,0x34,0x32,0x35,0x37,0x38,0x31,0x32,0x35,0x66,0x2e,0x78,0x78,
    ...
    0x20,0x3d,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,0x5f,0x33,0x39,0x2c,0x20,0x5f,
    0x33,0x39,0x2c,0x20,0x5f,0x33,0x39,0x2c,0x20,0x31,0x2e,0x30,0x66,0x29,0x3b,0x0a,
...
//    }
//
const vs_quad_source_hlsl5 = [753]u8 {
...
//    }
//
const fs_quad_source_hlsl5 = [435]u8 {
...
//    {
//        main0_out out = {};
//        float2 _28 = fract((gl_FragCoord.xy - float2(_17.tick)) * float2(0.004999999888241291046142578125));
//        float _39 = _28.x * _28.y;
...
//
//
const fs_bg_source_metal_macos = [505]u8 {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    ...
    0x28,0x30,0x2e,0x30,0x30,0x34,0x39,0x39,0x39,0x39,0x39,0x39,0x38,0x38,0x38,0x32,
    ...
    0x33,0x39,0x20,0x3d,0x20,0x5f,0x32,0x38,0x2e,0x78,0x20,0x2a,0x20,0x5f,0x32,0x38,
    ...
    0x5f,0x33,0x39,0x2c,0x20,0x5f,0x33,0x39,0x2c,0x20,0x5f,0x33,0x39,0x2c,0x20,0x31,
...
//    }
//
const vs_bg_source_wgsl = [414]u8 {
...
//    fn main_1() {
//      var xy : vec2f;
//      xy = fract(((gl_FragCoord.xy - vec2f(x_17.tick)) / vec2f(200.0f)));
...
//    }
//
const fs_bg_source_wgsl = [650]u8 {
    0x64,0x69,0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x28,0x6f,0x66,0x66,0x2c,0x20,
    0x64,0x65,0x72,0x69,0x76,0x61,0x74,0x69,0x76,0x65,0x5f,0x75,0x6e,0x69,0x66,0x6f,
    ...
    0x63,0x6b,0x29,0x29,0x20,0x2f,0x20,0x76,0x65,0x63,0x32,0x66,0x28,0x32,0x30,0x30,
    0x2e,0x30,0x66,0x29,0x29,0x29,0x3b,0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,0x78,0x5f,
    0x34,0x31,0x20,0x3d,0x20,0x76,0x65,0x63,0x33,0x66,0x28,0x28,0x78,0x79,0x2e,0x78,
    0x20,0x2a,0x20,0x78,0x79,0x2e,0x79,0x29,0x29,0x3b,0x0a,0x20,0x20,0x66,0x72,0x61,
    0x67,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x66,0x28,
    0x78,0x5f,0x34,0x31,0x2e,0x78,0x2c,0x20,0x78,0x5f,0x34,0x31,0x2e,0x79,0x2c,0x20,
    0x78,0x5f,0x34,0x31,0x2e,0x7a,0x2c,0x20,0x31,0x2e,0x30,0x66,0x29,0x3b,0x0a,0x20,
...
//    }
//
const vs_quad_source_wgsl = [692]u8 {
    0x64,0x69,0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x28,0x6f,0x66,0x66,0x2c,0x20,
    0x64,0x65,0x72,0x69,0x76,0x61,0x74,0x69,0x76,0x65,0x5f,0x75,0x6e,0x69,0x66,0x6f,
    0x72,0x6d,0x69,0x74,0x79,0x29,0x3b,0x0a,0x0a,0x73,0x74,0x72,0x75,0x63,0x74,0x20,
...
//    }
//
const fs_quad_source_wgsl = [348]u8 {
    0x64,0x69,0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x28,0x6f,0x66,0x66,0x2c,0x20,
    0x64,0x65,0x72,0x69,0x76,0x61,0x74,0x69,0x76,0x65,0x5f,0x75,0x6e,0x69,0x66,0x6f,
    0x72,0x6d,0x69,0x74,0x79,0x29,0x3b,0x0a,0x0a,0x76,0x61,0x72,0x3c,0x70,0x72,0x69,
...
pub fn bgShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        ...
        .GLES3 => {
            desc.vertex_func.source = &vs_bg_source_glsl300es;
            desc.vertex_func.entry = "main";
        ...
        .D3D11 => {
            desc.vertex_func.source = &vs_bg_source_hlsl5;
        ...
        .METAL_MACOS => {
            desc.vertex_func.source = &vs_bg_source_metal_macos;
        ...
        .WGPU => {
            desc.vertex_func.source = &vs_bg_source_wgsl;
            desc.vertex_func.entry = "main";
...
pub fn quadShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            desc.vertex_func.source = &vs_quad_source_glsl410;
            desc.vertex_func.entry = "main";
        ...
        .GLES3 => {
            desc.vertex_func.source = &vs_quad_source_glsl300es;
            desc.vertex_func.entry = "main";
        ...
        .WGPU => {
            desc.vertex_func.source = &vs_quad_source_wgsl;
            desc.vertex_func.entry = "main";
