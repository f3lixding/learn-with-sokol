...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/sprite2.glsl -o src/shaders/sprite2.glsl.zig -l glsl410:glsl300es:hlsl5:metal_macos:wgsl -f sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'spritetwo':
//        Get shader desc: shd.spritetwoShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
//            ATTR_spritetwo_pos => 0
//            ATTR_spritetwo_color0 => 1
//            ATTR_spritetwo_uv0 => 2
//    Bindings:
//        Image 'tex':
//            Image type: ._2D
//            Sample type: .FLOAT
...
//            Bind slot: SMP_smp => 0
//
pub const ATTR_spritetwo_pos = 0;
pub const ATTR_spritetwo_color0 = 1;
pub const ATTR_spritetwo_uv0 = 2;
pub const IMG_tex = 0;
pub const SMP_smp = 0;
//
//    #version 410
...
const vs_source_glsl410 = [303]u8 {
    ...
    0x20,0x2d,0x20,0x75,0x76,0x30,0x2e,0x79,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
//    #version 410
//
...
const vs_source_glsl300es = [264]u8 {
    ...
    0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x76,0x65,0x63,0x32,0x28,0x75,
    0x76,0x30,0x2e,0x78,0x2c,0x20,0x31,0x2e,0x30,0x20,0x2d,0x20,0x75,0x76,0x30,0x2e,
...
const vs_source_hlsl5 = [823]u8 {
    ...
    0x6c,0x6f,0x72,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x66,
    0x6c,0x6f,0x61,0x74,0x32,0x28,0x75,0x76,0x30,0x2e,0x78,0x2c,0x20,0x31,0x2e,0x30,
    0x66,0x20,0x2d,0x20,0x75,0x76,0x30,0x2e,0x79,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x53,
...
//        out.color = in.color0;
//        out.uv = float2(in.uv0.x, 1.0 - in.uv0.y);
//        return out;
//    }
//
//
const vs_source_metal_macos = [538]u8 {
    ...
    0x76,0x20,0x3d,0x20,0x66,0x6c,0x6f,0x61,0x74,0x32,0x28,0x69,0x6e,0x2e,0x75,0x76,
    0x30,0x2e,0x78,0x2c,0x20,0x31,0x2e,0x30,0x20,0x2d,0x20,0x69,0x6e,0x2e,0x75,0x76,
...
const vs_source_wgsl = [726]u8 {
    ...
    0x63,0x6f,0x6c,0x6f,0x72,0x30,0x3b,0x0a,0x20,0x20,0x75,0x76,0x20,0x3d,0x20,0x76,
    0x65,0x63,0x32,0x66,0x28,0x75,0x76,0x30,0x2e,0x78,0x2c,0x20,0x28,0x31,0x2e,0x30,
    0x66,0x20,0x2d,0x20,0x75,0x76,0x30,0x2e,0x79,0x29,0x29,0x3b,0x0a,0x20,0x20,0x72,
    ...
    0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x28,0x32,0x29,0x20,0x75,0x76,0x30,0x5f,
    ...
    0x30,0x5f,0x70,0x61,0x72,0x61,0x6d,0x3b,0x0a,0x20,0x20,0x75,0x76,0x30,0x20,0x3d,
    0x20,0x75,0x76,0x30,0x5f,0x70,0x61,0x72,0x61,0x6d,0x3b,0x0a,0x20,0x20,0x6d,0x61,
...
pub fn spritetwoShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "spritetwo_shader";
    switch (backend) {
        .GLCORE => {
